...
import Be10x from "../../assets/images/be10x.jpg";
import Blockchain from "../../assets/images/Blockchain Basics.png";
import Deloitte from "../../assets/images/deloittetechnologysimulation.jpg";
import Accenture from "../../assets/images/accenture.jpg";
import NextJS from "../../assets/images/nextjs.jpg";
import ReactCert from "../../assets/images/react_certificate.jpg";
...
export default function Resume() {
  ...
  const certifications = [
    {
      ...
      image: Be10x,
      description:
        "Completed hands-on training in AI productivity tools, rapid prototyping, automation and data analysis.",
    },
    {
      ...
      image: Blockchain,
      description:
        "Learned fundamentals of blockchain, smart contracts, decentralization, and Ethereum architecture.",
    },
    {
      ...
      image: Accenture,
      description:
      "Completed practical modules covering system architecture design, secure coding practices, feature implementation, debugging, and agile development workflows. Built a scalable backend solution, analyzed requirements, and delivered code aligned with industry standards."
    },
    {
      ...
      image: Deloitte,
      description:
        "Completed a virtual internship performing real Deloitte tasks: development, debugging and problem solving.",
    },
    
    {
      title: "Next.js Certification",
      issuer: "Programming Hub (Google Launchpad Partner)",
      date: "September 2024",
      image: NextJS,
      description: "Mastered Next.js fundamentals, SSR/SSG, API routes and frontend architecture.",
    },
    {
      ...
      date: "July 2024",
      image: ReactCert,
      description: "Certified in React, hooks, state management, components and frontend problem solving.",
    },
  ];
    ...
    <section id="resume" className="py-12 xs:py-16 md:py-24 relative">
      <div className="max-w-7xl mx-auto px-4 xs:px-6">
        <div className="text-center mb-10 xs:mb-12 md:mb-16" data-aos="fade-up">
          <h2 className="section-heading mb-3 xs:mb-4">Career Overview</h2>
        ...
        <div id="experience-section" className="mb-12 xs:mb-16" data-aos="fade-up">
  ...
  <div className="space-y-6 xs:space-y-8">
    ...
    <div data-aos="fade-right" data-aos-delay="100">
      <div className="flex items-center gap-2.5 xs:gap-3 mb-4 xs:mb-6">
        ...
        <h3 className="text-xl xs:text-2xl font-display font-bold text-white">Tech Stack</h3>
      </div>
  ...
  <div className="space-y-6 xs:space-y-8" data-aos="fade-left">
  ...
  {certifications.map((cert, index) => (
    <div
      key={index}
      className="glass-card p-4 group hover:border-primary-500/30 transition-all hover-lift"
    >
      <h4 className="text-base font-semibold text-white mb-1">{cert.title}</h4>
      <span className="text-xs text-dark-400">{cert.date}</span>

      <div className="mt-2 w-full h-44 overflow-hidden rounded-lg border border-dark-700">
        <img
          src={cert.image}
          alt={cert.title}
